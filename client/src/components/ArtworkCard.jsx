...
export default function ArtworkCard({ artwork, index, total, delay = 0 }) {
  ...
  return (
    <Reveal className={`work ${wide ? "is-wide" : ""}`} delay={delay}>
      <Link to={`/works/${artwork.id}`} className="work-link">
        <div className="work-frame">
          <img src={artwork.image} alt={title} loading="lazy" onLoad={measure} />
